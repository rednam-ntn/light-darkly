    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4 dark:border-gray-700">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Change API Key</h2>
          <button
            onClick={onClose}
        ...
        <div className="space-y-4 px-6 py-5">
          <div>
            <label htmlFor="api-key-input" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
            ...
            <input
              ...
              className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-500"
            />
          </div>

          {/* Privacy notice */}
          <div className="flex gap-3 rounded-md bg-blue-50 p-3 dark:bg-blue-900/30">
            <Shield size={20} className="mt-0.5 shrink-0 text-blue-600 dark:text-blue-400" />
        ...
        <div className="flex items-center justify-between border-t border-gray-200 px-6 py-4 dark:border-gray-700">
          <button
            onClick={handleClear}
            className="rounded-md px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/30"
          >
            Clear Key
          </button>
